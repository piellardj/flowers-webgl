...
var PlotterCanvasWebGL = (function (_super) {
    ...
    PlotterCanvasWebGL.prototype.initialize = function (backgroundColor) {
        ...
        gl_canvas_1.gl.viewport(0, 0, this.width, this.height);
    ...
    PlotterCanvasWebGL.prototype.drawLines = function (lines, color) {
        if (this.stemsShader && lines.length > 0) {
            ...
            gl_canvas_1.gl.enableVertexAttribArray(this.stemsShader.a["aVertex"].loc);
            ...
            gl_canvas_1.gl.vertexAttribPointer(this.stemsShader.a["aVertex"].loc, 2, gl_canvas_1.gl.FLOAT, false, 0, 0);
