...
var Corolla = (function () {
    ...
    Corolla.prototype.update = function (dt) {
        if (this.attachedPetals.length > 0 && Math.random() < PETALS_DROP_RATE * dt) {
            var detachedPetal = this.attachedPetals.pop();
            detachedPetal.center = { x: this.position.x, y: this.position.y };
            detachedPetal.rotationSpeed = noise_1.Noise.randomInRange(-1.5, 1.5);
...
var Parameters = (function () {
    ...
    Object.defineProperty(Parameters, "petalsOpacity", {
        get: function () {
    ...
    Object.defineProperty(Parameters, "useCanvas2D", {
        get: function () {
...
function loadShader(name, callback) {
    ShaderManager.buildShader({
        ...
        if (builtShader === null) {
            var errorMessage = "Failed to load or build the " + name + " shader.";
...
var PlotterCanvasWebGL = (function (_super) {
    ...
    function PlotterCanvasWebGL() {
        ...
        loadShader("lines", function (shader) { _this.linesShader = shader; });
        loadShader("ellipses", function (shader) { _this.ellipsesShader = shader; });
        loadShader("polygons", function (shader) { _this.polygonsShader = shader; });
        return _this;
    }
...
function plot(flowersManager, plotter) {
    plotter.initialize(parameters_1.Parameters.backgroundColor, parameters_1.Parameters.linesColor, parameters_1.Parameters.petalsOpacity);
    flowersManager.draw(plotter);
    plotter.finalize();
}
function main() {
    var plotter = parameters_1.Parameters.useCanvas2D ? new plotter_canvas_2d_1.PlotterCanvas2D() : new plotter_canvas_webgl_1.PlotterCanvasWebGL();
